...
<head>
    ...
    <script type="text/javascript">
        function changeImage(){
            $("#captchaImage").prop("src","${path}/admin/getImageCode?img"+Math.random());
        }
    </script>
</head>
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="form-top" style="width: 450px">
                        <div class="form-top-left">
                            ...
                            <p>Enter your username and password to log on:&nbsp;&nbsp;&nbsp;<font color="#a52a2a">${sessionScope.message}</font></p>
                        </div>
