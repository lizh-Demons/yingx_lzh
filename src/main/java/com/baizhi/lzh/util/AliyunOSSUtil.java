...
public class AliyunOSSUtil {
    ...
    private static String accessKeyId = "LTAI4GFTYCcFpF9SdK81kLut";
    private static String accessKeySecret = "72gM5CnrkhbGiJrzYajyKLlvcmV6TA";
    ...
    * */
    ...
    public static void interceptVideoCover(String bucketName,String videoName,String coverName){
        ...
        OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret);
        // 设置视频截帧操作。
        String style = "cover/snapshot,t_1000,f_jpg,w_800,h_600";
        // 指定过期时间为10分钟。
